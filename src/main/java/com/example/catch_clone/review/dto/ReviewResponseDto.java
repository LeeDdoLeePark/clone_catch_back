...
public record ReviewResponseDto(String reviewContent, Float tasteRating, Float atmosphereRating, Float serviceRating, Float totalRating, LocalDateTime createdAt,Long likeCount) {
